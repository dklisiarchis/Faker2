...
final class IbanTest extends TestCase
{
     ...
     */
    public function testChecksum(string $iban, string $checksum): void
    {
     ...
     * @param bool $isValid
     */
    public function testIsValid(string $iban, bool $isValid): void
    {
     ...
     * @return array[]
     */
    public function alphaToNumberProvider(): array
    {
        return [
            ['A', 10],
            ['B', 11],
     ...
     * @param int $number
     */
    public function testAlphaToNumber(string $letter, int $number): void
    {
     ...
     * @param int $result
     */
    public function testMod97(string $number, int $result): void
    {
