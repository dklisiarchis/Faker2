...
class File extends Base
{
    ...
    public static function file(
        string $sourceDirectory = self::TMP_DIR,
        string $targetDirectory = self::TMP_DIR,
        bool $fullPath = true
    ): string {
        ...
        if (false === copy($sourceFullPath, $destinationFullPath)) {
            throw new InvalidArgumentException(sprintf('Copy from source: %s to destination: %s failed', $sourceDirectory, $targetDirectory));
        }
